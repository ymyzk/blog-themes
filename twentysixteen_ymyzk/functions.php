...
function append_highlight_js() {
    wp_enqueue_style( 'highlight.js', '//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.6.0/styles/monokai.min.css' );
    wp_enqueue_script( 'highlight.js', '//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.6.0/highlight.min.js', array(), false, true );
